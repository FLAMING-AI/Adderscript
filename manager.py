...
while True:
    ...
    if a == 1:
        ...
        try:
            # https://raw.githubusercontent.com/FLAMING-AI/Adderscript/main/version.txt
            version = requests.get('https://raw.githubusercontent.com/FLAMING-AI/Adderscript/main/version.txt')
        except:
        ...
        if float(version.text) > 0.9:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/FLAMING-AI/Adderscript/main/adder.py')
                os.system('curl -l -O https://raw.githubusercontent.com/FLAMING-AI/Adderscript/main/manager.py')
